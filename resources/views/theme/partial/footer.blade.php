      ...
      <div class="row">
        ...
        <div class="col-lg-4  col-md-6 col-sm-6">
          <div class="single-footer-widget">
            ...
            @endif
              <form target="_blank" novalidate="true" method="post" action="{{route('subscriber.store')}}" method="get" class="form-inline">
                @csrf

                <div class="d-flex flex-row">

                  <input class="form-control" name="email" placeholder="Enter Email" value="{{old('email')}}" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Enter Email '"
                    required="" type="email">
                    @error('email')
        ...
        <div class="col-lg-2 col-md-6 col-sm-6">
          <div class="single-footer-widget">
            ...
            <div class="footer-social d-flex align-items-center">
              <a href="https://www.facebook.com/share/1FipkfmpVH/?mibextid=qi2Omg" target="_blank" >
